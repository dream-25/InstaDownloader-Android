package com.dream25.instagram.downloader.activities;
...
import com.dream25.instagram.downloader.BuildConfig;
import com.dream25.instagram.downloader.R;
import com.dream25.instagram.downloader.adapters.StoryAdapter;
import com.dream25.instagram.downloader.adapters.ProfileAdapter;
import com.dream25.instagram.downloader.api.CommonAPI;
import com.dream25.instagram.downloader.api.data.EdgeModel;
import com.dream25.instagram.downloader.api.data.EdgeSidecarModel;
import com.dream25.instagram.downloader.api.data.ResponseModel;
import com.dream25.instagram.downloader.api.model.FullDetailModel;
import com.dream25.instagram.downloader.api.model.NodeModel;
import com.dream25.instagram.downloader.api.model.StoryModel;
import com.dream25.instagram.downloader.api.model.TrayModel;
import com.dream25.instagram.downloader.constants.Constants;
import com.dream25.instagram.downloader.dialogs.RateDialog;
import com.dream25.instagram.downloader.fragments.DownloadFragment;
import com.dream25.instagram.downloader.fragments.InstagramWebFragment;
import com.dream25.instagram.downloader.listener.UserListInterface;
import com.dream25.instagram.downloader.preference.SharePrefs;
import com.dream25.instagram.downloader.utils.DirectoryUtils;
import com.dream25.instagram.downloader.utils.Utils;
...
import static com.dream25.instagram.downloader.utils.DirectoryUtils.createFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.linearLayoutShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "Check the best Instagram Downloader Of 2022 \n https://play.google.com/store/apps/details?id=com.dream25.instagram.downloader");
                sendIntent.setType("text/plain");

                Intent shareIntent = Intent.createChooser(sendIntent, null);
                startActivity(shareIntent);
                ((ClipboardManager) getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("clipboard", "Check the best Instagram Downloader Of 2022\nhttps://play.google.com/store/apps/details?id=com.dream25.instagram.downloader"));
